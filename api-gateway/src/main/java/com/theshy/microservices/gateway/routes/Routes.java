package com.theshy.microservices.gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute(){
        return GatewayRouterFunctions.route("product_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("productSwaggerServiceCircuitBreaker", URI.create("forward:/fallbackRoute")))
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute(){
        return GatewayRouterFunctions.route("order_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("orderSwaggerServiceCircuitBreaker", URI.create("forward:/fallbackRoute")))
                .filter(setPath("/api-docs"))
                .build();
    }
